return {
...

  {
    ...
    config = function()
      ...
      local function install_missing(parsers)
        ...
        for _, parser in ipairs(parsers) do
          if has_value(available, parser) and not has_value(installed, parser) and not installing[parser] then
      ...
      vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function(event)
          install_missing(parsers_for_filetype(vim.bo[event.buf].filetype))
